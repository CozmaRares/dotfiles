...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "d", function () awful.spawn('rofi -show combi -combi-modes "window,drun,run" -modes combi') end,
    ...
    awful.key(
        ...
        { description = "play previous", group = "audio" }
    ),
    awful.key(
        {},
        "XF86AudioPlay",
        function () awful.spawn("playerctl play-pause") end,
        { description = "toggle play", group = "audio" }
    ),
    awful.key(
        {},
        "XF86AudioNext",
